...
fn update_camera(
    ...
    camera.translation.smooth_nudge(&direction, CAMERA_DECAY_RATE, time.delta_secs());
}
...
fn move_player(mut player: Single<&mut Transform, With<Player>>, time: Res<Time>, kb_input: Res<ButtonInput<KeyCode>>) {
